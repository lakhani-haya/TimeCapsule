...
# Custom CSS for sophisticstyling
st.markdown("""
<style>
...
with st.sidebar:
    ...
    <div class="sidebar-section">
        <p style="font-size: 0.9rem; color: #495057; margin: 0.5rem 0; line-height: 1.5;">
    ...
    st.markdown("""
    <div class="sidebar-section">
        <p style="font-size: 0.9rem; color: #495057; margin: 0; line-height: 1.6;">
...
st.markdown("""
---
<div style="text-align: center; padding: 3rem 2rem; background: linear-gradient(135deg, #ffffff 0%, #f8f9fa 100%); border-radius: 12px; margin-top: 3rem; border: 1px solid #dee2e6; box-shadow: 0 8px 25px rgba(0,0,0,0.05);">
    <h4 style="color: #212529; font-family: 'Playfair Display', serif; font-weight: 400; font-size: 1.5rem; margin-bottom: 1rem;">Crafted for Tomorrow's You</h4>
    <p style="color: #6c757d; font-family: 'Source Sans Pro', sans-serif; font-style: italic; margin-bottom: 0; font-size: 1rem; line-height: 1.6;">Each reflection becomes a bridge between your present consciousness and future wisdom</p>
</div>
""", unsafe_allow_html=True)
